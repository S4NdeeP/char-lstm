...
def get_wmt_enfr_test_set(directory):
  """Download the WMT en-fr training corpus to directory unless it's there."""
...
def get_wmt_enfr_dev_set(directory):
  """Download the WMT en-fr training corpus to directory unless it's there."""
  dev_path = os.path.join(directory, "valid")
  return dev_path
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  test_path = get_wmt_enfr_test_set(data_dir)
  from_train_path = train_path + ".En"
  to_train_path = train_path + ".Hi"
  from_dev_path = dev_path + ".En"
  to_dev_path = dev_path + ".Hi"
  from_test_path = test_path + ".En"
  to_test_path = test_path + ".Hi"
  return prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_test_path, to_test_path, en_vocabulary_size,
                      fr_vocabulary_size, tokenizer)


def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_test_path, to_test_path, from_vocabulary_size,
  ...
  to_test_ids_path = to_test_path + (".ids%d" % to_vocabulary_size)
  from_test_ids_path = from_test_path + (".ids%d" % from_vocabulary_size)
  ...
  return (from_train_ids_path, to_train_ids_path,
          ...
          from_test_ids_path, to_test_ids_path,
