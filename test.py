...
tf.app.flags.DEFINE_float("dropout_prob", 0.8, "Dropout Probability")
...
tf.app.flags.DEFINE_string("save_dir", "/home/ec2-user/assn/current/data", "Data directory")
...
train_dir= "/home/ec2-user/assn/current/checkpoints/"
